      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
            We want you to be completely satisfied with our services. Here's our
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  ...
                  subscription plans. If you're not satisfied with our service,
                ...
                <ul className="mt-4 space-y-2 text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span>Have an active subscription</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0"
                    ...
                    <span>Submit a refund request within 14 days</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0"
                    ...
                    <span>Not have violated our terms of service</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ol className="mt-4 space-y-2 text-gray-600">
                  <li className="flex items-start">
                    <span className="w-6 h-6 bg-gradient-to-r from-emerald-600 to-green-600 rounded-full flex items-center justify-center text-white text-xs font-bold mr-3 mt-0.5 flex-shrink-0">
                      1
                    </span>
                    <span>
                      Contact our support team at support@nexavelosai.com
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-6 h-6 bg-gradient-to-r from-emerald-600 to-green-600 rounded-full flex items-center justify-center text-white text-xs font-bold mr-3 mt-0.5 flex-shrink-0">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      Approved refunds will be processed within 3-5 business
                      days
                    </span>
                  </li>
                </ol>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  ...
                  dashboard. Cancellation will take effect at the end of your
                  current billing period.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  If you cancel your subscription before the end of your billing
                  period, you will continue to have access to our services until
                  the end of that period, but will not be charged again.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2 text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span>
                      Services rendered after the 14-day guarantee period
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  We recommend that you review this policy periodically for any
                  updates or changes.
                </p>
              </div>
