      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
            <a
              href="/register"
              className="bg-gradient-to-r from-emerald-600 to-green-600 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-semibold hover:from-emerald-700 hover:to-green-700 transition-all duration-200 shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
            >
              Start Building Now
            </a>
            <a
              href="#features"
              className="bg-white/70 backdrop-blur-md border border-gray-200/50 text-gray-700 px-8 sm:px-10 py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-semibold hover:bg-white/90 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Learn More
            </a>
          </div>
          <div className="mt-12 sm:mt-16 flex justify-center">
            <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-200/50">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-[#3BC1A8] mb-2">
                    10K+
                  </div>
                ...
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-[#249E94] mb-2">
                    1M+
                  </div>
                  <div className="text-gray-600 text-sm sm:text-base">
                    Conversations
                ...
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-[#0C7779] mb-2">
                    99.9%
                  </div>
                  <div className="text-gray-600 text-sm sm:text-base">
                    Uptime
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white/70 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <svg
              ...
              <p className="text-gray-600 text-center leading-relaxed text-sm sm:text-base">
                Generate embeddable JavaScript snippets or React components in
                seconds. No coding required - just copy, paste, and you're live.
              </p>
            </div>
            <div className="bg-white/70 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <a
                href="/register"
                className="w-full bg-gradient-to-r from-emerald-600 to-green-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-[#0C7779] hover:to-[#249E94] transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center block"
              >
                Get Started
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                "NexaVelosAI transformed our customer support. The AI agents
                handle 80% of our inquiries automatically, saving us countless
                hours."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                ...
                improved our conversion rates by 40% since implementing
                NexaVelosAI."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                ...
                agent up and running on our website. The React components are
                perfect."
              </p>
              <div className="flex items-center">
